...
=======
Интерактивный интернет-магазин для веб-разработчиков с каталогом товаров, корзиной и оформлением заказа.  
[Демо проекта](https://ваша-ссылка-на-демо.ru)
...
>>>>>>> 2b3166fa2cc4968087f3cfab511a5b3133af3aa1
src/
├── base/ # Базовые классы
│ ├── Api.ts # HTTP-клиент
